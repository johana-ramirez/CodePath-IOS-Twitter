...
//
//AAAAAAAAAAAAAAAAAAAAADW5hgEAAAAApw%2FteDIc36Uuwx9QHgBgcsQ7bFY%3DGetV2CNbr2XmMdRupE65V7TNA01lycbTbg5rXckygssaDJnKYw

import UIKit
import BDBOAuth1Manager

class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "nYHVaWiQ1lwLsGvzXwl5AAxs9", consumerSecret: "Ccb48AwDKohc4FCSLGrppuhqI2KsMsd95IK6vD5hnykzWBj0qC")
    var loginSuccess: (() -> ())?
